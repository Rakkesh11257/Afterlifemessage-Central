# AfterLifeMessage.in - Cognito User Pool Creation Script
...
if ($LASTEXITCODE -eq 0) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        $identityPoolResponse = aws cognito-identity create-identity-pool `
            ...
            --cognito-identity-providers "ProviderName=cognito-idp.us-east-1.amazonaws.com/$userPoolId,ClientId=$appClientId,ServerSideTokenCheck=false"
